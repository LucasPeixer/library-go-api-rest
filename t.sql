...
SELECT proname, proargnames, prorettype::regtype, prosrc
FROM pg_proc
JOIN pg_namespace ON pg_proc.pronamespace = pg_namespace.oid
WHERE proname = 'log_inventory_changes'
AND nspname = 'public';

DROP FUNCTION log_inventory_changes();
DROP TRIGGER track_inventory_changes ON books;
...
BEGIN 
  ...
  INSERT INTO books (book_id, book_title, book_price, book_synopsis,)
